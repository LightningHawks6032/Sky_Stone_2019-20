...
public class BeltBot_Outtake {
    ...
    //Encoder positions
    private final double LEFT_LIFT_UPPER_ENCODER = 2100, LEFT_LIFT_LOWER_ENCODER = 0,
    RIGHT_LIFT_UPPER_ENCODER = -2100, RIGHT_LIFT_LOWER_ENCODER = 0, ENCODER_MARGIN_OF_ERROR = 50, TOP_AUTO_EXTEND = 1000,
    ...
    private void manageHorizontalSlide(){
        double pow = gamepad.right_stick_y*0.9;
